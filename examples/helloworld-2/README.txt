...
- In Linux:
   + For J2ME:
      $ java -cp ksoap2-generating-stub-0.1-SNAPSHOT-jar-with-dependencies.jar:$JAVA_HOME/lib/tools.jar ksoap2.generator.Wsdl2J2me -w HelloWorld2.wsdl -g ./j2me
   + For Android:
      $ java -cp ksoap2-generating-stub-0.1-SNAPSHOT-jar-with-dependencies.jar:$JAVA_HOME/lib/tools.jar ksoap2.generator.Wsdl2Android -w HelloWorld2.wsdl -g ./android

- In Windows:
   + For J2ME:
      $ java -cp ksoap2-generating-stub-0.1-SNAPSHOT-jar-with-dependencies.jar;"%JAVA_HOME%\lib\tools.jar" ksoap2.generator.Wsdl2J2me -w HelloWorld2.wsdl -g .\j2me
   + For Android
      $ java -cp ksoap2-generating-stub-0.1-SNAPSHOT-jar-with-dependencies.jar;"%JAVA_HOME%\lib\tools.jar" ksoap2.generator.Wsdl2Android -w HelloWorld2.wsdl -g .\android
...
- Before invoking web services from J2ME or Android, you just need to configure
  ...
  Configuration.setConfiguration("http://localhost:8080/Ws2Ksoap/services/HelloWorld2");

  // incorrect because of using 127.0.0.1
  Configuration.setConfiguration("http://127.0.0.1:8080/Ws2Ksoap/services/HelloWorld2");

  // correct because the emulator can find the web services.
  Configuration.setConfiguration("http://192.168.2.3:8080/Ws2Ksoap/services/HelloWorld2");